...
export default function SetEditorPage() {
    ...
    return <Container size="lg">
        <Group justify="space-between">
            ...
            <ActionIcon variant="subtle" color="rgba(255, 255, 255, 1)" component={Link} to={`/set/${setId}`}>
        ...
        {set.cards.map((card, index1) => <Paper shadow="md"
            ...
            <Group justify="space-between">
                ...
                <ActionIcon variant="subtle" color="rgba(255, 255, 255, 1)" onClick={() => setSet({ ...set, cards: set.cards.filter((_value, index2) => index1 != index2) })}>
